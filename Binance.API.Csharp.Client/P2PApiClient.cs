...
{
    public class P2PApiClient : ApiClientAbstract, IApiClient
    {
        ...
        public P2PApiClient(string apiKey, string apiSecret, string apiUrl = @"https://p2p.binance.com", string webSocketEndpoint = @"wss://nbstream.binance.com/market", bool addDefaultHeaders = true) : base(apiKey, apiSecret, apiUrl, webSocketEndpoint, addDefaultHeaders)
        {
        }
